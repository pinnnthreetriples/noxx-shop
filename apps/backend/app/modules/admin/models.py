...
class Setting(Base):
    ...
    terms_text_ru: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    terms_text_de: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    terms_text_el: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    terms_text_ro: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    terms_text_bg: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    terms_text_mo: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    terms_text_sr: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    terms_text_tr: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    refund_policy_text_en: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    refund_policy_text_ru: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    refund_policy_text_de: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    refund_policy_text_el: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    refund_policy_text_ro: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    refund_policy_text_bg: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    refund_policy_text_mo: Mapped[Optional[str]] = mapped_column(Text, nullable=True)

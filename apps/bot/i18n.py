...
_STRINGS = {
    ...
    "bg": {
        ...
        "welcome": "Добре дошли! Отвори мини приложението и разгледай видео каталога.",
    ...
    "sr": {
        ...
        "welcome": "Добродошли! Отворите мини-апликацију и погледајте видео каталог.",
        "open_app": "Отвори продавницу",
        "support_cmd": "Подршка је доступна у мини-апликацији: Профил → Подршка.",
        "paysupport_cmd": "За проблеме са плаћањем направите тикет са темом „Проблем са плаћањем“.",
